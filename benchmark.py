...
if __name__ == '__main__':
    ...
    levels = [1, 3, 5, 7, 9]
    codec_levels = od([('bloscpack_blosclz', levels),
                       ('bloscpack_lz4', levels),
                       ('bloscpack_lz4hc', levels),
                       ('bloscpack_snappy', levels),
                       ('bloscpack_zlib', levels),
                       ('tables_blosc_blosclz', levels),
                       ('tables_blosc_lz4', levels),
                       ('tables_blosc_lz4hc', levels),
                       ('tables_blosc_snappy', levels),
                       ('tables_blosc_zlib', levels),
                       ('tables_lzo', levels),
                       ('tables_zlib', levels),
                       #('tables_bzip2', levels),
                       ('tables', [0, ]),
